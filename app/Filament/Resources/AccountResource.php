            ...
            ->groups([
                Group::make('classification.classification_name')
                    ...
                    ->orderQueryUsing(function (Builder $query, string $direction) {
                        $query->orderByRaw("CAST(SUBSTRING_INDEX(account_code, '.', 1) AS UNSIGNED) $direction")
                            ->orderByRaw("CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(account_code, '.', -2), '.', 1) AS UNSIGNED) $direction")
                            ->orderByRaw("CAST(SUBSTRING_INDEX(account_code, '.', -1) AS UNSIGNED) $direction");
                    })
                    ->collapsible(),
